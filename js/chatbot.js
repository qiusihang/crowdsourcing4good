var Chatbot = function(taketurn, show_message) {
    ...
    this.typing_rate = 20; // ms per character
    ...
    this.utter = function(utterance, start_time, i = 0) {
        ...
        if ( text.indexOf("buttons") == 0 || text.indexOf("checkbox") == 0 || text.indexOf("hourselection") == 0 ) {    // show buttons/checkbox
        ...
        setTimeout(function(){
            ...
            setTimeout(function(){
                ...
                that.utter(utterance, start_time, i+1);
            }, option.length * that.typing_rate > 5000?5000:option.length * that.typing_rate);
        }, this.turn_taking);
    }
